...
- Local endpoints communicate with the private gatway via a [PoWeb](https://specs.relaynet.network/RS-016) server on `127.0.0.1:13276`. This server is implemented with the PoWeb binding and [ktor](https://ktor.io).
...
- When communicating with couriers, this private gateway uses the [CogRPC binding](https://specs.relaynet.network/RS-008) through [Relaycorp's CogRPC client](https://docs.relaycorp.tech/relaynet-cogrpc-jvm/).
